#> asset:artifact/3229.flash_grenade/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3229.flash_grenade/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3229
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"フラッシュグレネード","color":"#ceff47"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"着弾した瞬間閃光を放つグレネード。","color":"white"}','{"text":"周囲の敵を怯ませる。","color":"white"}','{"text":"似たようなモノをみたような...","color":"dark_gray"}']

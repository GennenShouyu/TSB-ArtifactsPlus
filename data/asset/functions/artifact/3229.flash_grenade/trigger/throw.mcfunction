#> asset:artifact/3229.flash_grenade/trigger/throw
#
#
#
# @within function asset:artifact/3229.flash_grenade/trigger/3.main
...
# Object召喚
    data modify storage api: Argument.ID set value 3208

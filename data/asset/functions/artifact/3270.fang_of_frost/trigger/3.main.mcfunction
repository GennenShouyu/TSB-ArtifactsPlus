#> asset:artifact/3270.fang_of_frost/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/3270.fang_of_frost/trigger/2.check_condition
...
#カウント用
    scoreboard players set @s 1B6.Count 5
...
# スケジュールループ
     execute if score @s 1B6.Charge matches 2 run function asset:artifact/3270.fang_of_frost/trigger/schedule_loop

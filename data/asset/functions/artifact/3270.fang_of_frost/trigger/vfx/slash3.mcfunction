#> asset:artifact/3270.fang_of_frost/trigger/vfx/slash3
#
#
#
...
# 斬撃
    ...
    data modify storage api: Argument.FieldOverride set value {Color:4359413,Frames:[20335,20336,20337],Scale:[4f,4f,0.1f],Transformation:{left_rotation:[0.271f,-0.653f,0.271f,0.653f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}

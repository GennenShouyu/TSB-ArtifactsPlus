...
# 神器のメイン処理部
#
# @within function asset:artifact/3207.prototype/trigger/2.check_condition
...
# 残り回数が1回の時発動した場合
    execute unless data storage asset:context Items.mainhand.id run data modify storage api: Argument.ID set value 3208
...
# 発砲
    execute anchored eyes positioned ^-0.35 ^-0.15 ^ facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet run function asset:artifact/3207.prototype/trigger/bullet

#> asset:artifact/3243.selected_soy_sauce/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3243.selected_soy_sauce/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3243
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:honey_bottle"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '[{"text":"厳選された醤油","color":"red"}]'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"素材からこだわって作られた特選醤油。"}]','[{"text":"決して飲み物ではないが、飲むとMPを120回復し、"}]','[{"text":"攻撃力+7%を短時間得る。"}]','[{"text":"但し、急性高ナトリウム血症を起こし、大ダメージを受けるかもしれない。"}]','[{"text":"　"}]','[{"text":"くれぐれも麦茶と間違えないように。","color":"gray"}]']

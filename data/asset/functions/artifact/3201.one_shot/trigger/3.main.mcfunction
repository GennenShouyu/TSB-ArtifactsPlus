...
# 神器のメイン処理部
#
# @within function asset:artifact/3201.one_shot/trigger/2.check_condition
#> Private
# @private
...
# 発砲
    execute anchored eyes positioned ^-0.35 ^-0.15 ^ facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet run function asset:artifact/3201.one_shot/trigger/bullet

#> asset:artifact/3264.runaway_minecart/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3264.runaway_minecart/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3264
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"暴走トロッコ","color":"red","bold":true,"italic":false,"underlined":true}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"目の前に爆走するトロッコを発射する。","color":"white"}','{"text":"轢かれた敵はトロッコに運ばれる。","color":"white"}','{"text":"また、トロッコは一定時間経過で爆発し、","color":"white"}','{"text":"乗っている敵にダメージを与える。","color":"white"}']

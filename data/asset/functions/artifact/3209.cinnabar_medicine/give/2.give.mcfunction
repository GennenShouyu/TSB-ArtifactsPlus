#> asset:artifact/3209.cinnabar_medicine/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3209.cinnabar_medicine/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3209
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"赤い鉱石を砕いて粉末状にした薬。"}]','[{"text":"使用すると、30秒間 攻撃力+15%、MP回復+60%、"}]','[{"text":"防御力+20%を得るが、毒状態になる。"}]','[{"text":"　"}]','[{"text":"かつて古代の皇帝たちが、不老不死になれると信じて","color":"gray"}]','[{"text":"飲んでいた薬。","color":"gray"}]']

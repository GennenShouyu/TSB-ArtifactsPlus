#> asset:effect/4210.mirage_of_memory/tick/
#
# Effectのtick処理
#
# @within function asset:effect/4210.mirage_of_memory/_/tick
...
# 1 秒おきにダメージを与える
    execute if data storage asset:context this{Tick:0} run function asset:effect/4210.mirage_of_memory/tick/deal_damage

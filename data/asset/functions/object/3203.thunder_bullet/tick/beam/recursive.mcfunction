#> asset:object/3203.thunder_bullet/tick/beam/recursive
#
#
#
# @within function
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:object/3203.thunder_bullet/tick/beam/hit

# 再帰
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:object/3203.thunder_bullet/tick/beam/recursive

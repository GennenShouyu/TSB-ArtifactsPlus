#> asset:object/3208.flash_grenade/summon/
#
# Object召喚処理の呼び出し時に実行されるfunction
#
# @within asset:object/alias/3208/summon
...
# 元となるEntityを召喚する
    ...
    function asset:object/3208.flash_grenade/summon/m with storage asset:temp Args

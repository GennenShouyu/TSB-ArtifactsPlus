#> asset:object/3202.thunderclouds/tick/beam/hit
#
#
#
# @within function asset:object/3202.thunderclouds/tick/beam/recursive
...
# 演出
    execute at @e[type=#lib:living_without_player,tag=LandingTarget,distance=..30,limit=1] run playsound minecraft:item.totem.use player @a ~ ~ ~ 0.4 2

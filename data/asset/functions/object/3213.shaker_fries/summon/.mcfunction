#> asset:object/3213.shaker_fries/summon/
#
# Object召喚処理の呼び出し時に実行されるfunction
#
# @within asset:object/alias/3213/summon
...
# 元となるEntityを召喚する
    ...
    function asset:object/3213.shaker_fries/summon/m with storage asset:temp Args

#> asset:artifact/3225.void_bayonet_sword/trigger/slash
#
#
#
...
# ダメージ
    data modify storage api: Argument.Damage set value 92.0f
    data modify storage api: Argument.AttackType set value "Physical"
    data modify storage api: Argument.ElementType set value "None"
    data modify storage api: Argument.AdditionalMPHeal set value 25.0f

#> asset:artifact/3218.thunderclouds_umbrella/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3218.thunderclouds_umbrella/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3218
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"雷雲を呼ぶ蝙蝠傘","color":"gray"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"周りにある雷の因子を変幻させ、雷雲を生成し自らに呼び込む。","color":"white"}','{"text":"呼び込んだ雷雲は、周囲の生物に対し放電を行う。","color":"white"}','{"text":" ","color":"white"}','{"text":"不運な雨に見舞われたあなたを「護る」傘。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [120x4]

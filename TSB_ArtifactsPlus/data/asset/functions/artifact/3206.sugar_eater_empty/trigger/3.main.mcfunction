#> asset:artifact/3206.sugar_eater_empty/trigger/3.main
#
# 神器のメイン処理部
#
...
# 残り回数が1回の時発動した場合
    ...
    execute unless data storage asset:context Items.mainhand.id run data modify storage api: Argument.ID set value 3205

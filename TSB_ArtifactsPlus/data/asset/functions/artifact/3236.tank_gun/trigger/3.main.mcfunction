...
# 神器のメイン処理部
#
# @within function asset:artifact/3236.tank_gun/trigger/2.check_condition
...
# 前方拡散設定
    ...
    data modify storage lib: Argument.Spread set value 0.02

# 前方拡散を実行する
    execute as @e[type=marker,tag=SpreadMarker,limit=1] run function lib:forward_spreader/circle
# 発砲
    execute anchored eyes positioned ^-0.35 ^-0.15 ^ facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet run function asset:artifact/3236.tank_gun/trigger/bullet

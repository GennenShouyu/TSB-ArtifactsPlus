#> asset:artifact/3242.onicha/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3242.onicha/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3242
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:honey_bottle"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '[{"text":"鬼のように美味い茶","color":"aqua"}]'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"某有名Youtuberがプロデュースしている麦茶。"}]','[{"text":"飲むとワクワクし、1分半、移動速度+10%、跳躍力上昇IIを得る。"}]','[{"text":"　"}]','[{"text":"日本の麦茶変えるぞ！","color":"gray"}]']

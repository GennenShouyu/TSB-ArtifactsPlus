#> asset:artifact/3201.one_shot/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3201.one_shot/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3201

# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:ender_eye"

# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '[{"text":"ワンショット","color":"#ff8219"}]'

# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"Minecraftを模造したソーシャルゲームの","color":"white"}','{"text":"中に眠る銃火器。","color":"white"}','{"text":"並大抵の相手なら一撃で粉砕する。","color":"white"}','{"text":" ","color":"gray"}','{"text":"どんな敵も一撃で葬り去る火力をもつロマン砲。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [3500,4900]

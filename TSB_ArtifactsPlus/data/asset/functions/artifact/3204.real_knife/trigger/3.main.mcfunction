...
# 確率でダメージ増加
    # 疑似乱数取得
        execute store result score $Random Temporary run random value 0..98
    # 増加
    ...
    # 通常攻撃
        execute if score $Random Temporary matches 1..98 at @e[type=#lib:living,type=!player,tag=Victim] run function asset:artifact/3204.real_knife/trigger/attack
    # リセット

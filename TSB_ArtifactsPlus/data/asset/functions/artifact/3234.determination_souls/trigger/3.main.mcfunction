#> asset:artifact/3234.determinaion_souls/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/3234.determinaion_souls/trigger/2.check_condition
...
# 効果音
    ...
    particle minecraft:trial_spawner_detection ~ ~1 ~ 0.5 0.5 0.5 0 30

# エフェクトを付与
    data modify storage api: Argument.ID set value 4215

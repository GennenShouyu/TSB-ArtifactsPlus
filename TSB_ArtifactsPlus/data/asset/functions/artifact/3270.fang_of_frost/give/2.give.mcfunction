#> asset:artifact/3267.chill_gale_knife/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3267.chill_gale_knife/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3270
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"氷の牙","color":"blue"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"青く輝く刃をもつ短刀。","color":"white"}','{"text":"冷気を纏っており、切りつけた相手を凍らせる。","color":"white"}','{"text":"オフハンドにも持つことで、連撃が発生する。","color":"white"}','{"text":" ","color":"white"}','{"text":"この北方で作られたダガーは、","color":"gray"}','{"text":"敵をカチコチに凍らせてしまうという。","color":"gray"}']

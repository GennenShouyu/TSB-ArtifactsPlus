#> asset:artifact/3250.truthseeker/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3250.truthseeker/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3250
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"トゥルースシーカー","color":"#ff6325"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"湾曲した刃を持つ特殊な刀。"}','{"text":"コンボフィニッシュでは刺突攻撃を行う。"}','{"text":"ある砦の番人は、尋問の間もこのおぞましい剣を","color":"gray"}','{"text":"手放さないという。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value ["235-300 / 580-730"]
...
# MP回復量
    # data modify storage asset:artifact MPHealWhenHit set value 6.8
# 神器のクールダウン (int) (オプション)
    data modify storage asset:artifact LocalCooldown set value 7

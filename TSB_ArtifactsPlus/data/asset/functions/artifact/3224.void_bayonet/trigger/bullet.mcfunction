#> asset:artifact/3224.void_bayonet/trigger/bullet
#
#
#
# @within function
#       asset:artifact/3224.void_bayonet/trigger/3.main
#       asset:artifact/3224.void_bayonet/trigger/bullet
...
# 演出
    particle dust 0.161 0.161 0.161 0.5 ~ ~ ~ 0 0 0 0 6

# 距離減衰をするためにスコアを増やす
    scoreboard players add $Distance_Damping Temporary 1

# 着弾
    execute if entity @s[tag=Landing] run function asset:artifact/3224.void_bayonet/trigger/hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:artifact/3224.void_bayonet/trigger/bullet
#> asset:artifact/3224.void_bayonet/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3224.void_bayonet/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3224
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"虚ろに覗く銃口","color":"#8a7095","underlined":true}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"8個のペレットに分散する散弾を放つショットガン。"}','{"text":"かつて快楽殺人鬼が愛用していたとされる銃のレプリカ。","color":"gray"}','{"text":"この弾丸を受けた人は、癒えない銃創を作るとされている。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [120x8]
...
# 神器のクールダウン (int) (オプション)
    data modify storage asset:artifact LocalCooldown set value 35

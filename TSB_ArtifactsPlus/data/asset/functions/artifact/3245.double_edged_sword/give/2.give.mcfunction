#> asset:artifact/3245.double_edged_sword/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/3245.double_edged_sword/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 3245
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"諸刃の剣","color":"white"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"両側に刃がついた刀。","color":"white"}','{"text":"攻撃した際、50%の確率で自分が死ぬ。","color":"white"}','{"text":"だが、極稀に会心の一撃を与える。","color":"white"}','{"text":" ","color":"white"}','{"text":"敵を斬ることより、運試しに適した刀。","color":"gray"}']
